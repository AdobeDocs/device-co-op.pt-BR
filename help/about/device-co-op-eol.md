...
Este documento fornece respostas a perguntas frequentes sobre o plano de fim da vida útil do Adobe Experience Cloud Device Co-op (EOL). Quando esse plano entrar em vigor, a Adobe fornecerá um aviso avançado nas [Notas de versão da Experience Cloud](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html?lang=pt-BR) e na [Atualização prioritária do produto](https://www.adobe.com/subscription/priority-product-update.html).

O Device Co-op foi um programa que permitiu que os participantes trabalhassem em conjunto para identificar melhor os consumidores em todos os pontos de contato digitais, garantindo ao mesmo tempo o mais alto nível de privacidade e transparência.
...
- [Adobe Audience Manager](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/aam-overview.html?lang=pt-BR)
- [Adobe Advertising Cloud](https://experienceleague.adobe.com/docs/advertising-cloud.html?lang=pt-BR)
- [Adobe Target](https://experienceleague.adobe.com/docs/target/using/introduction/intro.html?lang=pt-BR)
...
Sua implementação do Serviço de ID de visitante atual capacita o Analytics [CDA](https://experienceleague.adobe.com/docs/analytics/components/cda/overview.html?lang=pt-BR). Se sua ID declarada existente for um email com hash, ele poderá ser usado para potencializar os seguintes recursos:
...
Para [!DNL Audience Manager] e [!DNL Advertising Cloud] usuários, os dados de [!DNL Device Co-op] não estarão disponíveis para serem transferidas para gráficos de terceiros. Os dados do [!DNL Device Co-op] serão migrados somente para usuários do [!DNL Analytics Ultimate] usando o CDA com o [!DNL Device Co-op] alternando para Configuração em campo. Todas as outras soluções não terão seus dados migrados.

## É obrigatório adotar outros recursos?

Embora a adoção de outros recursos do Adobe não seja obrigatória, você deve iniciar a implementação de outros recursos o mais rápido possível para permitir tempo e coordenação apropriada antes da [!DNL Device Co-op] descontinuação.
